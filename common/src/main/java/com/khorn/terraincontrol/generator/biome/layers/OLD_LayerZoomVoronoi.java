...
public class OLD_LayerZoomVoronoi extends Layer
{

    public OLD_LayerZoomVoronoi(long seed, Layer childLayer)
    {
        super(seed);
    ...
    public int[] getInts(ArraysCache cache, int x, int z, int xSize, int zSize)
    {
        ...
        int n = (xSize >> i) + 3;
        int i1 = (zSize >> i) + 3;
        int[] arrayOfInt1 = this.child.getInts(cache, k, m, n, i1);

        int i2 = n << i;
        int i3 = i1 << i;
        int[] arrayOfInt2 = cache.getArray(i2 * i3);
